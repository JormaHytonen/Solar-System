/* Original Copyright 2005 - 2017 Annpoint, s.r.o.
   Use of this software is subject to license terms.

   Modify by Jorma Hytonen 26.6.2017
   for NameDay Datagrid
*/
...
(function() {
    ...
    dataModal.ModalStatic = {};

    dataModal.ModalStatic.list = [];

    // hide the last one
    dataModal.ModalStatic.hide = function() {
    ...
    dataModal.ModalStatic.remove = function(modal) {
        var list = dataModal.ModalStatic.list;
    ...
    dataModal.ModalStatic.close = function(result) {
        dataModal.ModalStatic.result(result);
        dataModal.ModalStatic.hide();
    };

    dataModal.ModalStatic.result = function(r) {
        var list = dataModal.ModalStatic.list;
        if (list.length > 0) {
    ...
    dataModal.ModalStatic.displayed = function(modal) {
        var list = dataModal.ModalStatic.list;
        for (var i = 0; i < list.length; i++) {
            if (list[i] === modal) {
                return true;
    ...
    dataModal.ModalStatic.stretch = function() {
        if (this.list.length > 0) {
    ...
    dataModal.ModalStatic.last = function() {
        var list = dataModal.ModalStatic.list;
        if (list.length > 0) {
    ...
    dataModal.Modal = function(options) {
        ...
        this.showHtml = function(html) {
            ...
            if (dataModal.ModalStatic.displayed(this)) {
        ...
        this._update = function() {
            ...
            */
            ...
            dataModal.ModalStatic.list.push(this);
        ...
        this.hide = function(options) {
            ...
            //dataModal.ModalStatic = null;
            dataModal.ModalStatic.remove(this);
    ...
    dataModal.Modal.alert = function(message, options) {
        options = options || {};
        ...
        return dataModal.getPromise(function(success, failure) {
            ...
            var modal = new dataModal.Modal(options);
            ...
            buttonOK.onclick = function(e) {
                parent.dataModal.ModalStatic.close("OK");
            };
            ...
            //var buttons = "<div style='margin: 10px 0px'><button onclick='parent.dataModal.ModalStatic.close();' autofocus>OK</button></div>";
    ...
    dataModal.Modal.confirm = function(message, options) {
        options = options || {};
        options.height = options.height || 40;
        options.useIframe = false;
        ...
        return dataModal.getPromise(function(success, failure) {
            ...
            buttonCancel.onclick = function(e) {
                parent.dataModal.ModalStatic.close();
            };
    ...
    dataModal.Modal.prompt = function(message, defaultValue, options) {
        ...
        return dataModal.getPromise(function(success, failure) {
            ...
            input.onkeydown = function(e) {
                switch (e.keyCode) {
                    case 13:
                        parent.dataModal.ModalStatic.close(this.value);
                        break;
                    case 27:
                        parent.dataModal.ModalStatic.close();
                        break;
            ...
            buttonOK.className = modal.theme + "_ok";
            buttonOK.onclick = function(e) {
                parent.dataModal.ModalStatic.close(input.value);
            };
    ...
    dataModal.Modal.close = function(result) {
        if (parent && parent.dataModal && parent.dataModal.ModalStatic) {
            parent.dataModal.ModalStatic.close(result);
        }
        else {
            throw "Unable to close dataModal.Modal dialog.";
        }
    };

    dataModal.Modal.closeSerialized = function() {
        var last = dataModal.Modal.opener() || dataModal.ModalStatic.last();
        var ref = last._body();
        ...
        dataModal.Modal.close(result);
    };

    dataModal.Modal.opener = function() {
        return parent && parent.dataModal && parent.dataModal.ModalStatic && parent.dataModal.ModalStatic.list[parent.dataModal.ModalStatic.list.length - 1];
    };

    if (typeof dataModal.getPromise === "undefined") {
        dataModal.getPromise = function(f) {
            if (typeof Promise !== 'undefined') {
                return new Promise(f);
            }

            dataModal.Promise = function(f) {
                var p = this;
            ...
            return new dataModal.Promise(f);

 ...
 * @source   ./Projektit/fmiweb/weather_fmi.php
 * @server   smb://jormah@ubuntu-lnx/data/local/fmiweb
 * @updated  28.1.2021 => for Kuopio, Savilahti Data
 *
 */
...
<head>
    ...
    <title>FMI Säätiedot | Windrose | Datatuki Kuopio</title>

    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="RRD Weather Graph and JpGraph Windrose by Datatuki.fi, Kuopio, Finland">
...
<!-- Here is where the server sent data will appear -->
    ...
    <div class="header">
        <div class="container">
            <h3>Kuopio Savilahti [FMISID=101586]</h3>
    ...
    <div class="content">
        <div class="container">
            <div class="main">
                <div class="sid">Kuopio Savilahti säätiedot [FMISID=101586]</div>
                <br />

                <div id="dte">
                    Tiedot ladataan Ilmatieteenlaitoksen palvelusta 10 min välein<br />
                    Tulokset ladataan palvelimelle 20 min välein (4,24,44)
                    <br /><br />
                    <?php
                    ...
                    if (file_exists($filename)) {
                        ...
                        echo "<font size='-1'>";
                        echo "&nbsp;&nbsp;<b>Huom!</b>&nbsp;25.2.2021: Uusi mittausasema: Kuopio Savilahti";
                        echo "</font>";
                    }
                    ?>
                </div>
                ...
                <div id="upd">
                    <a style="color:navy;" href="https://ilmatieteenlaitos.fi/suomen-havainnot?station=101586" target="_blank">
                    Kuopion havainnot Ilmatieteenlaitokselta (FMI).</a>
                </div>
                <br />
                ...
                <div id="D1">
                    ...
                    <br /><br />
                    <b>The system (28.1.2021)</b><br />
                    &nbsp;&nbsp;Operating system: Linux<br />
                    &nbsp;&nbsp;Kernel: 4.15.0-134-generic<br />
                    &nbsp;&nbsp;Machine: x86_64 (Ubuntu 18.04.4 LTS Server)<br />
                    &nbsp;&nbsp;Server software: Apache/2.4.29<br />
                    &nbsp;&nbsp;Data collection: Python 2.7.17<br />
                    &nbsp;&nbsp;Graph: RRDtool 1.7.0 <br />

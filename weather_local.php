 ...
 * @link     https://ubuntu-lnx/weather/weather_local.php
 * @source   ./Projektit/fmiweather
 * @server   sftp://jormah@ubuntu-lnx:22/data/htdocs/weather/weather_local.php
 *
 */
        ...
        <div class="container">
            <div class="main">
                ...
                <div id="dte">
                    ...
                    /* Pictures */
                    $realPath = "../fmiweb/FI101421-all/";
                    $filename = $realPath . "temperature-day.png";
                ...
                <div class="layout">
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/temperature-day.png" alt="Temperature">
                    </div>
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/humid-day.png" alt="Humidity">
                    </div>
                </div>

                <div class="layout">
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/windy-day.png" alt="Wind"><br />
                        <!-- Windrose picture -->
                        <div class="desc">Tuulen suunta&nbsp;<a data-fancybox="gallery" href="../windgraph/windimg/windrose.png" /> kompassi </a>&nbsp;(Windrose)
                        </div>
                    </div>
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/press-day.png" alt="Pressure"><br />
                        <div class="desc">&nbsp;</div>
                    </div>
                </div>
                ...
                <div class="layout">
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/rainy-day.png" alt="Wind">
                        <div class="desc">&nbsp;</div>
                    </div>
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/weather-day.png" alt="Weather">
                ...
                <div class="layout">
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/temperature-week.png" alt="Temperature">
                    </div>
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/humid-week.png" alt="Humidity">
                    </div>
                </div>

                <div class="layout">
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/windy-week.png" alt="Wind"><br />
                        <!-- Windrose picture -->
                        <div class="desc">Tuulen suunta&nbsp;<a data-fancybox="gallery" href="../windgraph/windimg/windrose.png" /> kompassi </a>&nbsp;(Windrose)
                        </div>
                    </div>
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/press-week.png" alt="Pressure">
                        <div class="desc">&nbsp;</div>
                    </div>
                </div>
                ...
                <div class="layout">
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/rainy-week.png" alt="Wind">
                        <div class="desc">&nbsp;</div>
                    </div>
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/weather-week.png" alt="Weather">
                        <div class="desc"><a href="wawacodes.html" class="iframe">Näytä WaWa Koodit</a></div>
                    </div>
                </div>
                ...
                <div class="layout">
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/temperature-month.png" alt="Temperature">
                    </div>
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/humid-month.png" alt="Humidity">
                    </div>
                </div>

                <div class="layout">
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/windy-month.png" alt="Wind"><br />
                        <!--
                            sftp://jormah@ubuntu-lnx:22/data/htdocs/windgraph/windrose_graph.php
                            /data/htdocs/windgraph/windimg/
                        -->
                        <div class="desc">Tuulen suunta&nbsp;<a data-fancybox="gallery" href="https://ubuntu-lnx/windgraph/windimg/windrose.png" /> kompassi </a>&nbsp;(Windrose)
                        </div>
                    </div>
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/press-month.png" alt="Pressure">
                        <div class="desc">&nbsp;</div>
                    </div>
                </div>
                ...
                <div class="layout">
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/rainy-month.png" alt="Wind">
                        <div class="desc">&nbsp;</div>
                    </div>
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/weather-month.png" alt="Weather">
                        <div class="desc"><a href="wawacodes.html" class="iframe">Näytä WaWa Koodit</a></div>
                    </div>
                </div>
                ...
                <div class="layout">
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/temperature-year.png" alt="Temperature">
                    </div>
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/humid-year.png" alt="Humidity">
                    </div>
                </div>

                <div class="layout">
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/windy-year.png" alt="Wind"><br />
                        <div class="desc">Tuulen suunta&nbsp;<a data-fancybox="gallery" href="windimg/windrose.png" /> kompassi </a>&nbsp;(Windrose)
                        </div>
                    </div>
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/press-year.png" alt="Pressure">
                        <div class="desc">&nbsp;</div>
                    </div>
                </div>
                ...
                <div class="layout">
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/rainy-year.png" alt="Wind">
                        <div class="desc">&nbsp;</div>
                    </div>
                    <div class="layout__item layout__item--figure">
                        <img src="<?php echo $realPath ?>/weather-year.png" alt="Weather">
                        <div class="desc"><a href="wawacodes.html" class="iframe">Näytä WaWa Koodit</a></div>
                    </div>
                </div>
